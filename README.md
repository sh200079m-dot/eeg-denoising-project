...
## 📌 Project Overview
This project implements an adaptive channel-wise thresholding method for EEG signal denoising, comparing it with the classical Rigrsure method.
...
## 👩‍💻 Author
Shaghayegh Masoudian - Advanced Digital Signal Processing (ADSP)
